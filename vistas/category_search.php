...
<?php
    ...
    if(isset($_GET['category_id_del'])){
        require_once("./php/categoria_eliminar.php");
            ...
            $url="index.php?vista=category_search&page="; //esta variable va a contener la url completa del sistema 
            $registros=15; // esta va a mostrar el numero total de registrados en cada pagina
            $busqueda=$_SESSION['busqueda_categoria']; //esta variable se va a usar para realizar la busqueda
