...
$id=(isset($_GET['user_id_up'])) ? $_GET['user_id_up']: 0 ; // aqui decimos que si la variable viene definida se la asignamos a la varibale id pero si no va a ser igual a 0
...
if($check_usuario->rowCount()>0){  //
    ...
    $datos=$check_usuario->fetch() // solo se esta seleccionado un unico usuario en la consulta
?>
    ...
    <?php }else{
        include("./incluir/error_alert.php");
    }
    $check_usuario=null;
    ?>
</div>